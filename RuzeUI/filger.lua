		...
		if not bar then
			...
			if self.Mode == "ICON" then
				...
				if bar.count then
					...
					bar.count:SetFont(C.media.font, 11, "OUTLINE")
				...
				if bar.time then
                    ...
                    bar.time:SetFont(C.media.font, 8, "OUTLINE")
				...
				if bar.count then
					...
					bar.count:SetFont(C.media.font, 10, "OUTLINE")
				...
				if bar.spellname then
					...
					bar.spellname:SetFont(C.media.font, 8, "OUTLINE")
